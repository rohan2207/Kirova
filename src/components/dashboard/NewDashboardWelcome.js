...
const NewDashboardWelcome = ({ name, totalSaved = 0 }) => {
  return (
    <div className="py-6">
      ...
      <div className="mt-6 flex flex-col sm:flex-row">
        ...
        <button className="sm:ml-4 bg-green-600 text-white px-6 py-3 rounded-lg shadow-sm hover:bg-green-700 transition-colors">
          Make a List
        </button>
      </div>
    </div>
...
export default NewDashboardWelcome;